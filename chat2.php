...
echo '<body>';
 ...
 <!-- Auto refresh by k alle 5 minuten-->
        ...
        <div style="padding: .2rem 3rem;">
            <a id="logout" href="logout.php"><svg fill="#FFF"viewBox="-8 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        function sendMessage(){
            ...
            if (message === "notfall1337") {
                ...
                $.ajax({
                    ...
                    data: {message: message, user_id: current_user_id},
                    success: function(data) {
                        $("#input_message").val('');
        ...
        $('#search-query').keyup(function() {
            ...
            success: function(data) {
                ...
                $.each(results, function(index, value) {
                    html += '<li class="list-group-item" data-user-id="'+value.user_id+'">'+value.user_id+'</li>' ;
                });
